<div class="container booking">
    <div class="row">
        <form action="<?php echo base_url('hotels/booking'); ?>" method="post">
        <div class="col-md-8">
                ...
                <div class="panel-body">
                    <div class="row form-group">
                        ...
                        <div class="col-md-2 col-xs-3">
                            <select id="" class="form-control" name="title">
                                <option value="" disabled="" translate="" selected="selected">Title</option>
                                <option selected label="Mr" value="Mr">Mr</option>
                                <option label="Ms" value="Ms">Ms</option>
                                <option label="Mrs" value="Mrs">Mrs</option>
                            </select>
                        </div>
                        <div class="col-md-4 col-xs-9">
                            <input type="text" id="" class="form-control" required="" placeholder="First Name" name="first_name" value="Qasim">
                        </div>
                        <div class="col-md-4 col-xs-12">
                            <input type="text" id="" class="form-control" required="" placeholder="Last Name" name="last_name" value="Hussain">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-2"> <label> Email* </label></div>
                        <div class="col-md-10">
                            <input type="email" id="" class="form-control" required="" name="email" placeholder="Your e-voucher will be sent to this email." value="compoxition@gmail.com">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-2"><label>Mobile number* </label> </div>
                        <div class="col-md-5">
                            <select id="" class="form-control" name="mobile_code">
                        ...
                        <div class="col-xs-12 col-md-5">
                            <input required="" type="tel" id="" name="number" maxlength="12" minlength="4" ng-required="true" aria-required="true" placeholder="Number" class="form-control" value="03311442244">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-default guest">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-2 form-groupt"> <label for="email">Payment Method*</label></div>
                        <div class="col-md-8 form-group">
                            ...
                            <div class="col-md-3">
                                <label for="bitcoins" class="control control--radio">
                                    Bitcoins
                                    <input type="radio" name="payment_method" id="bitcoins" value="Bitcoin" />
                                    <div class="control__indicator"></div>
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <select class="form-control"  required="required" name="month">
                                        ...
                                        <?php for ($m = 1; $m <= 12; ++$m) { ?>
                                            <option label="<?php echo sprintf("%02d", $m) . ' - ' . date('F', mktime(0, 0, 0, $m, 1)); ?>" value="<?php echo $m; ?>"><?php echo sprintf("%02d", $m) . ' - ' . date('F', mktime(0, 0, 0, $m, 1)); ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="clearfix visible-xs visible-sm">&nbsp;</div>
                                <div class="col-md-4">
                                    <select class="form-control" required="required" name="year">
                                        ...
                                        <?php for ($y = 2018; $y < 2033; $y++) { ?>
                                        <option value="2018" selected>2018</option>
                                            <option label="<?php echo $y; ?>" value="<?php echo $y; ?>"><?php echo $y; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
            ...
            <button class="btn btn-success btn-block btn-lg booking_botton" name="booking-btn">Complete Booking</button>
        </div>
        <div class="col-md-4 summary">
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <img src="<?php echo $detail->image_path . 'thumbs/' . $detail->room->image; ?>" class="img-responsive" alt="">
                    </div>
                    <div class="col-md-8">
                        <div class="row">
                            <h6 class="m0"><strong><?php echo $detail->room->name; ?></strong></h6>
                            <p  class="m0"><?php echo $detail->room->city . ', ' . $detail->room->country; ?></p>
                            <p  class="m0">
                                <?php for ($i = 1; $i <= $detail->room->rating; $i++) { ?>
                    ...
                    <div class="col-md-12">
                        <div class="hotel_details_panel__checkout">
                            <ul class="no-margin no-padding">
                                <li><b> Check-in date</b><span class="pull-right"><?php echo $formated_checkin; ?></span></li>
                                <li><b> Check-out date</b><span class="pull-right"><?php echo $formated_checkout; ?></span></li>
                                <li><b> Number of nights </b> <span class="pull-right"><?php echo $nights->format("%a"); ?></span></li>
                                <li><b> Number of rooms </b> <span class="pull-right"><?php echo $detail->room->total_rooms; ?></span></li>
                            </ul>
                            <input type="hidden" name="checkin" value="<?php echo $checkin; ?>" />
                            <input type="hidden" name="checkout" value="<?php echo $checkout; ?>" />
                            <input type="hidden" name="adults" value="<?php echo $adults; ?>" />
                            <input type="hidden" name="supplier" value="<?php echo $detail->room->supplier_email; ?>" />
                            <input type="hidden" name="room_id" value="<?php echo $detail->room->room_id; ?>" />
                            <input type="hidden" name="price" value="<?php echo $detail->room->price; ?>" />
                        </div>
                    </div>
                </div>
                <div class="panel panel-default">
                    ...
                    <div class="panel-body m0">
                        <p class="m0"><i class="fa fa-bed"></i> 01. <strong><?php echo $detail->room->room_title; ?></strong> <span class="pull-right">For <?php echo $adults; ?> Adults</span></p>
                        <hr>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <h4>
                                ...
                                <div class="pull-right"><strong>USD <small>$</small><?php echo $detail->room->price; ?></strong></div>
                            </h4>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                ...
                <div class="panel panel-white">
                    ...
                    <div class="panel-body text-chambray">
                        ...
                        <hr>
                        <p><i class="fa fa-envelope-o"></i> info@travelhope.com</p>
                    </div>
                </div>
            </div>
        </div>
