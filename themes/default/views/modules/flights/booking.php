    ...
    <div class="row">
        <div class="col-md-12">
            <form action="<?php echo base_url( 'flights/save_booking' ); ?>" method="post" id="booking_form">
                ...
                <input type="hidden" name="custom_payload[booking_token]"
                       value="<?= $booking['data']['custom_payload']['booking_token']; ?>">
                <input type="hidden" name="custom_payload[visitor_uniqid]"
                       value="<?= $params['custom_payload']['visitor_uniqid']; ?>">
                                        ...
                                        <div class="col-md-6">
                                            <label for="pay_now" class="control control--radio">
                                                ...
                                                <input checked type="radio" onclick="payment_type('pay_now');"
                                                       name="payment_method" id="pay_now" checked="checked" value="pay_online"/>
                                                <div class="control__indicator"></div>
                                            </label>
                                        </div>
                                        <?php }
                                        if($ota_modules->hotels->pay_later){
                                        ?>
                                        <div class="col-md-6">
                                            <label for="pay_leter" class="control control--radio">
                                                ...
                                                <input type="radio" id="pay_leter" onclick="payment_type('pay_later');"
                                                       name="payment_method"  <?php if(!$ota_modules->hotels->pay_online){ ?>checked="checked"<?php } ?> value="pay_later"/>
                                                <div class="control__indicator"></div>
                                            </label>
                                        </div>
                                        <?php } ?>
                                ...
                                <div class="row credit-card__form-container">
                                    <div class="col-md-7">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" placeholder="Your Name"
                                                       id="name_card"
                                                       name="payment_details[name_card]" <?php if ( $booking['data']['mode'] == 'sandbox' ) { ?>  value="David Baker"  readonly <?php } ?>>
												<?php if ( $booking['data']['mode'] == 'sandbox' ) { ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" id="card_no" name="payment_details[card_no]"
                                                       type="text"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-xs-8">
                                                <input type="text" required="required"
                                                       name="payment_details[security_code]"
                    ...
                    <div class="row">
                            ...
                            <div class="panel-body m0">
                                <ul class="no-margin no-padding">
									<?php foreach ( $booking['data']['flights'] as $key => $flight ) {
										...
										?>
                                        <li>
                                            <img style="width: 35px; float: left; margin-right: 5px;"
                                                 src="<?php echo base_url(); ?>assets/images/airlines/<?= $flight['operating_airline']['iata'] ?>.png"
                                                 lass="img-responsive" alt="">
                                            ...
                                            <input type="hidden" name="flight_data[<?= $key; ?>][src]" value="<?= $flight['from_code']; ?>">
                                            <input type="hidden" name="flight_data[<?= $key; ?>][dst]" value="<?= $flight['to_code']; ?>">
									...
									<?php } ?>
                                    <li><b><?= lang( '016' ) ?></b> <span
                                                class="pull-right"><?= $passengers['adults']; ?></span>
                        ...
                        <div class="form-group total-wrapper">
                            ...
                            <div class="well well-sm"
                                 style="color:#000000 !important;background:white;border: 4px solid #eee;">
								<?= lang( '0146' ) ?> EURO
                                <span class="pull-right">
                        <strong>
