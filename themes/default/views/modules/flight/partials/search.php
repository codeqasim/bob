...
<form id="search_form_kiwi" class="search_form responsive" action="<?php echo site_url( 'flights/' ); ?>" method="POST">
    <div class="col-md-6 c25 hide_on_availability">
    ...
    <div class="col-md-5 col-sm-6 col-xs-12 c20">
        <div class="form-group">
    ...
    <div class="bgfade col-md-3 col-xs-12 c20">
        <div class="form-group">
    ...
    <div class="col-md-4 col-xs-12 pull-left c10">
        <div class="form-group">
    ...
    <div class="col-md-12 col-25 col-xs-12 c100">
        <div class="progress-btn">
            <button class="btn btn-primary btn-block ladda-button spin btn-lg" data-style="expand-left"><span
                        class="ladda-label"><?= lang( '010' ) ?></span></button>
        </div>
    </div>
</form>
<script>
