                        ...
                        <div class="col-md-4">
                            <div class="airline-detail">
                                <img class="img-responsive"
                                     src="<?= site_url('assets/images/airlines/'.$value['airline']) ?>.png" alt="">
                                <div class="flight-no">
                                    <div><strong>
                    ...
                    <?php if (!empty($value['routes'][1])) { ?>
                        ...
                        <div class="row mlr0">
                            <div class="col-md-4">
                                <div class="airline-detail">
                                    <img class="img-responsive"
                                         src="<?= site_url('assets/images/airlines/' . $return_departure_airline) ?>.png"
                                         alt="">
                                    <div class="flight-no">
                                        <div>
                                            <strong><?= ucwords(get_airline_name($return_departure_airline)); ?></strong>
                                        </div>
                                        <span><?php echo $return_departure_airline; ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="flight-time">
                                    <div class="flight-arrival">
                                        <h4><?= date('H:i', $return_arrival); ?></h4>
                                        <span><?= $value['routes'][1][1] ?></span>
                                    </div>
                                    <div class="trip-map">
                                        <h5><?= $value['return_duration'] ?></h5>
                                        <div class="img-line">
                                    ...
                                    <div class="flight-depart">
                                        <h4><?= date('H:i', $return_departure) ?></h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="Arrives">
                                ...
                                <div><?php echo $routes['city_to'] ?> - <?php echo $routes['city_to'] ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
