...
<div class="panel-body">
    ...
    <hr style="1px solid #d2d2d2">
        ...
        <form action="<?php echo base_url('login'); ?>" method="post">
            ...
            <h2></h2>
            <p class="text-center">New to TRAVELHOPE ?</p>
            <h2></h2>
            <div class="progress-btn">
            <a href="<?php echo base_url(); ?>signup" class="btn btn-primary btn-block ladda-button spin" data-style="expand-left"><span class="ladda-label">Sign up!</span></a>
            </div>
        </form>
