                                ...
                                <div class="theme-search-results-item theme-payment-page-item-thumb">
                                    <div class="row" data-gutter="20">
                                        <div class="col-md-9 ">
                                            ...
                                            <a class="theme-search-results-item-flight-payment-details-link collapsed" href="#FlightPaymentDetails" data-toggle="collapse" aria-expanded="false" aria-controls="FlightPaymentDetails">Flight Details &nbsp;
                                                <i class="fa fa-angle-down"></i>
                                            </a>
                                            <div class="_pt-20 collapse" id="FlightPaymentDetails" aria-expanded="false" style="height: 20px;">
